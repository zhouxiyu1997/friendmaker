...
const TRANSLATIONS_EN = {
  ...
  "S2 Mini 需要填写 WiFi 凭证才能自动连接网络。SSID 和密码会在编译时写入固件。": "The S2 Mini needs WiFi credentials to connect automatically. The SSID and password are written into the firmware during compilation.",
