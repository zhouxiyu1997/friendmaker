...
const TRANSLATIONS_EN = {
  ...
  "S2 Mini 需要填写 WiFi 凭证才能自动连接网络。SSID 和密码会在编译时写入固件。留空静态 IP 则走 DHCP 自动获取。": "The S2 Mini needs WiFi credentials to connect automatically. The SSID and password are written into the firmware during compilation. Leave the static IP empty to use DHCP.",
